export const doctorsData = [
  {
    ...
    patientReviews: [
      ...
      {
        recommendation: false,
        feedback: "The clinic wait time was too long, even with an appointment. Doctor was good once I finally saw him.",
        patientName: "M. R***",
        timeAgo: "1 month ago"
      }
    ],
...
reviewCategories: [
...

  {
    slug: "dr-ahmed-raza",
    name: "Dr. Ahmed Raza",
    specialties: "Dermatologist, Cosmetic",
    qualifications: "MBBS, FCPS (Dermatology), MAACS (USA), DDSC (UK)",
    image: "/d1.jpg",
    isVerified: true,
    waitTime: "Under 15 Min",
